...
red.W = rand(size(red.W));    %inicializamos

%Construcción del array de bias
red.b = zeros(1, size(trainTargets, 2));
red.b = red.b + 1;    %inicializamos, siempre a 1
...
for i=1:parametros.maxIter,
    ...
    for j=1:size(trainTargets, 2),
        ...
        [red.W(:, j)] = reglaAprendizaje (red.W(:, j), red.b(j), randomRowInput, e, parametros.fAprendizaje);
